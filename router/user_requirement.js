...
module.exports = (models, keycloak) => {
    ...
    router.param("user_requirement", (req, res, next, id) => {
    ...
    router.get("/:user_requirement/users", keycloak.protect("realm:user"), (req, res) => {
    ...
    router.get("/window", keycloak.protect("realm:user"), (req, res) => {
